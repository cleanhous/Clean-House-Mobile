...
export default function Chaveiro() {
  ...
  async function verAgenda(item) {
    ...
    try {
      ...
      Alert.alert(
        "Erro",
        "Não foi possível carregar a agenda: " + erro.message
      );
    }
  }
  ...
  async function confirmarContratacao() {
    ...
    try {
      ...
      Alert.alert("Erro", "Falha ao confirmar contratação: " + erro.message);
    }
  }
    ...
    <ScrollView style={estilos.container}>
      ...
      <View style={estilos.conteudo}>
        ...
        <Text style={estilos.subtitulo}>
          Oferecemos serviços de chaveiro de alta qualidade.
        </Text>
        <FiltroPrestadores
          nota={nota}
