...
export default function Arquiteto() {
  ...
  async function buscarPrestadoresComFiltros() {
    try {
      ...
      Alert.alert(
        "Erro na Busca",
        "Não foi possível buscar arquitetos. Verifique sua conexão ou tente mais tarde."
      );
      definirPrestadores([]);
  ...
  function formatarPreco(valor) {
    ...
    return `R$ ${numero.toFixed(2).replace(".", ",")} por hora`; // Alterado para "por hora" para arquiteto
  }
  ...
  return (
    ...
    >
      ...
      <View style={estilos.conteudo}>
        <Text style={estilos.titulo}>Serviços de Arquitetura</Text>
        <Text style={estilos.subtitulo}>
          Encontre os melhores arquitetos para o seu projeto.
        </Text>
