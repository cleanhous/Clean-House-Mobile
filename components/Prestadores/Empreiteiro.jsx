...
export default function Empreiteiro() {
  ...
  return (
    ...
    >
      <NavBarHome title={"Empreiteiro"} />
      <View style={estilos.conteudo}>
        <Text style={estilos.titulo}>Serviços de Empreiteiro</Text>
        <Text style={estilos.subtitulo}>
          Encontre os melhores empreiteiros para suas necessidades.
        </Text>
        ...
        <Text style={estilos.subtitulo2}>Nossos Empreiteiros</Text>
        ...
        {prestadoresFiltrados.length > 0 ? (
          ...
          <Text style={estilos.textoNenhum}>
            Nenhum empreiteiro encontrado com os filtros aplicados. Tente outros
            critérios.
          </Text>
        )}
      </View>
