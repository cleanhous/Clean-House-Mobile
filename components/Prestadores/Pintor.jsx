...
export default function Pintor() {
  ...
  return (
    ...
    >
      ...
      <View style={estilos.conteudo}>
        <Text style={estilos.titulo}>Serviços de Pintor</Text>
        <Text style={estilos.subtitulo}>
          Encontre os melhores pintores para suas necessidades.
        </Text>
        ...
        <Text style={estilos.subtitulo2}>Nossos Pintores</Text>
        ...
        {prestadoresFiltrados.length > 0 ? (
          ...
          <Text style={estilos.textoNenhum}>
            Nenhum pintor encontrado com os filtros aplicados. Tente outros
            critérios.
          </Text>
        )}
      </View>
